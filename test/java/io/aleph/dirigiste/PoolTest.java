...
public class PoolTest {
    ...
    public void testPoolUtilizationsSizeLessThan4096() throws InterruptedException {
        ...
        pool.acquire(KEY);
        Thread.sleep(250);
        assertEquals(400, pool._utilizations._reservoirs.get(KEY)._ringBuffer._values.length);
    }
    ...
    public void testPoolUtilizationsSizeMoreThan4096() throws InterruptedException {
        ...
        pool.acquire(KEY);
        Thread.sleep(250);
        assertEquals(4096, pool._utilizations._reservoirs.get(KEY)._ringBuffer._values.length);
    }
    ...
    public void testPoolQueueLengthSizeLessThan4096() throws InterruptedException {
        ...
        pool.acquire(KEY);
        Thread.sleep(250);
        assertEquals(400, pool._queueLengths._reservoirs.get(KEY)._ringBuffer._values.length);
    }
